...
using (var scope = app.Services.CreateScope())
{
    ...
    // Seed Airlines (lista IATA/ICAO completa) — só corre numa base de dados completamente
    // vazia (primeira vez). Antes corria em TODOS os arranques e repunha qualquer código que
    // faltasse, o que fazia reaparecer airlines apagadas a cada reinício/deploy.
    if (!db.Airlines.Any())
    {
